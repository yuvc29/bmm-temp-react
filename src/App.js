    ...
    // <BrowserRouter>
      <Routes>
        <Route path="/" >
          ...
          <Route path="/movie-details/Hall-name_and_date-time/MallSeatMatrix" element={<MallSeatMatrix user = {user}/>} />
          <Route path="/movie-details/Hall-name_and_date-time/MallSeatMatrix/Bokking-details" element={<BookingSummary user = {user} />} />
          <Route path="/movie-details/Hall-name_and_date-time/MallSeatMatrix/Bokking-details/Ticket-details" element={<Ticket user = {user}></Ticket>} />
